...
{{-- <header class="app-header">
    <nav class="navbar navbar-expand-lg navbar-light">
                                            ...
                                            <div class="position-relative">
                                                <a href="./app-chat.html"
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="{{ asset('templates/mdrnz/images/svgs/icon-dd-chat.svg') }}"
                                                ...
                                                <a href="./app-invoice.html"
                                                    ...
                                                    <div
                                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                        <img src="{{ asset('templates/mdrnz/images/svgs/icon-dd-invoice.svg') }}"
                                                            alt="" class="img-fluid" width="24"
                                                            height="24">
                                                    </div>
                                                    <div class="d-inline-block">
                                                ...
                                                <a href="./app-contact2.html"
                                                    ...
                                                    <div
                                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                        <img src="{{ asset('templates/mdrnz/images/svgs/icon-dd-mobile.svg') }}"
                                                            alt="" class="img-fluid" width="24"
                                                            height="24">
                                                    </div>
                                                    <div class="d-inline-block">
                                        ...
                                        <div class="col-6">
                                            <div class="position-relative">
                                                <a href="./page-user-profile.html"
                                                    ...
                                                    <div
                                                        class="bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                                        <img src="{{ asset('templates/mdrnz/images/svgs/icon-dd-cart.svg') }}"
                                                            alt="" class="img-fluid" width="24"
                                                            height="24">
                                                    </div>
                                                    <div class="d-inline-block">
        ...
        <div class="d-block d-lg-none">
            <img src="{{ asset('templates/mdrnz/images/logos/dark-logo.svg') }}" class="dark-logo" width="180"
                alt="" />
            <img src="{{ asset('templates/mdrnz/images/logos/light-logo.svg') }}" class="light-logo" width="180"
                alt="" />
        </div>
                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                    <li class="nav-item dropdown">
                        <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                            ...
                            <img src="{{ asset('templates/mdrnz/images/svgs/icon-flag-en.svg') }}" alt=""
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                            <div class="message-body" data-simplebar>
                                <a href="javascript:void(0)"
                                    ...
                                    <div class="position-relative">
                                        <img src="{{ asset('templates/mdrnz/images/svgs/icon-flag-en.svg') }}"
                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                            ...
                            <div class="message-body" data-simplebar>
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="me-3">
                                        <img src="{{ asset('templates/mdrnz/images/profile/user-10.jpg') }}"
                        ...
                        <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown"
                            ...
                            <div class="d-flex align-items-center">
                                <div class="user-profile-img">
                                    <img src="{{ asset('templates/mdrnz/images/profile/user-1.jpg') }}"
                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                            ...
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="message-body">
                                    <a href="{{ route('setting.account') }}"
                                        ...
                                        <span
                                            ...
                                            <img src="{{ asset('templates/mdrnz/images/svgs/icon-account.svg') }}"
                                ...
                                <div class="d-grid py-4 px-7 pt-8">
                                    <x-inputs.form method="POST" action="{{ route('logout') }}">
                                        <a href="javascript:void(0)" class="btn btn-outline-primary w-100" onclick="event.preventDefault(); this.closest('form').submit();">Log Out</a>
                                    </x-inputs.form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-4 ms-n4">
                                    <div class="position-relative p-7 border-start h-100">
                                        ...
                                        <ul class="">
                                            ...
                                            <li class="mb-3">
                                                <a class="fw-semibold bg-hover-primary"
                                                    href="{{ route('setting.account') }}">User
                                                    Application</a>
                                            </li>
                                            <li class="mb-3">
                                                <a class="fw-semibold bg-hover-primary"
                    ...
                    <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                        ...
                        <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="d-flex align-items-center justify-content-between py-3 px-7">
                                    <h5 class="mb-0 fs-5 fw-semibold">Notifications</h5>
                                    <span class="badge text-bg-primary rounded-4 px-3 py-1 lh-sm">1
                                        new</span>
                                </div>
                                <div class="message-body" data-simplebar>
                                    <a href="javascript:void(0)"
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="profile-dropdown position-relative" data-simplebar>
                                    ...
                                    <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                        ...
                                        <div class="ms-3">
                                            <h5 class="mb-1 fs-3">{{ auth()->user()->name }}</h5>
                                            <span class="mb-1 d-block">{{ auth()->user()->roles->pluck('name')[0] }}</span>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level my-3">
                                ...
                                <ul class="px-8 mt-7 mb-4">
                                    ...
                                    <li class="sidebar-item py-2">
                                        <a class="fw-semibold text-dark"
                                            href="{{ route('setting.account') }}">User Application</a>
                                    </li>
                                    <li class="sidebar-item py-2">
                                        <a class="fw-semibold text-dark"
