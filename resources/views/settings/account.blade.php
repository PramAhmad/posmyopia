<x-layouts.app>
    <x-slot:title>Account Setting</x-slot>
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="text-center">
                                                <label for="profile-image">
                                                    <img src="{{ asset('templates/mdrnz/images/profile/user-1.jpg') }}" alt=""
                                ...
                                <div class="col-lg-6 d-flex align-items-stretch">
                                    <div class="card w-100 position-relative overflow-hidden">
                                        <div class="card-body p-4">
                                            ...
                                            <form>
                                                <div class="mb-4">
                                                    <x-inputs.input type="password" label="Current Password" id="current_password" name="current_password" placeholder="Current Password" aria-label="Current Password"/>
                                                </div>
                                                <div class="mb-4">
                                                    <x-inputs.input type="password" label="New Password" id="password" name="password" placeholder="New Password"/>
                                                </div>
                                                <div class="">
                                                    <x-inputs.input type="password" label="Confirm Password" id="password_confirmation" name="password_confirmation" placeholder="Confirm Password"/>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card w-100 position-relative overflow-hidden mb-0">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        <x-inputs.input type="text" label="Your Name" id="name" name="name" placeholder="Your Name" aria-label="Your Name" value="{{ auth()->user()->name }}" required/>
                                                    </div>
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-12">
                                                    <div
                                                        ...
                                                        <x-buttons.button-save-with-icon/>
                                                        <x-buttons.button-cancel type="button" onclick="location.href='{{ route('home') }}'"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
