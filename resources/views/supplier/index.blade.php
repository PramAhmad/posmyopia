<x-layouts.app>
    <x-slot:title>Supplier</x-slot>
                ...
                <div class="row">
                    <div class="col-md-4 col-xl-2">
                        <div class="position-relative">
                            <x-inputs.input type="text" class="search-datatable ps-5" id="input-search" placeholder="Search Supplier" autocomplete="false" />
                            <i class="ti ti-search position-absolute top-50 start-0 translate-middle-y fs-6 text-dark ms-3"></i>
                        </div>
                    </div>

                    @if ((auth()->user()->hasRole('superadmin')) | (auth()->user()->hasPermissionTo('create supplier')))
                    <div class="col-md-8 col-xl-10 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                        <x-buttons.button-primary data-bs-toggle="modal" data-bs-target="#modal-supplier" class="btn-add-supplier"><i class="ti ti-plus"></i>Add supplier</x-buttons.button-primary>
                    </div>
                    @endif
                </div>
            </div>
            <div class="table-responsive">
                {!! $dataTable->table(['class' => 'table align-middle text-nowrap supplier-datatable w-100']) !!}
            </div>
        </x-cards.card>
        <x-elements.modal id="modal-supplier" data-bs-backdrop="static" data-bs-keyboard="false" size="modal-xl">
            <div class="modal-body">
                <x-inputs.form class="form-supplier">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <x-inputs.input id="shop_name" name="shop_name" class="" label="Shop Name" />
                        </div>

                        <div class="col-md-6 mb-2">
                            <x-inputs.input id="type" name="type" class="" label="Type" />
                        </div>
        ...
        @vite('resources/js/page/supplier.js')
        @endpush
</x-layouts.app>