$(function(){
    const dtTable = window.LaravelDataTables["supplier-table"]
    ...
    $('table.dataTable tbody').on('click', 'tr td .btn-edit', function(){
        ...
        $.ajax({
            type: 'POST',
            url: `${baseUrl}/supplier/${t.data('id')}/edit`,
            data: {id:t.data('id')},
            beforeSend: function() {
            ...
            success: function(response) {
                ...
                $.each(response.data, function(i, item) {
                    if (i === 'photo') {
                        const fileUrl = `/upload/supplier/${item}`
    ...
    $('form').on('submit', function(e){
        ...
        const actionUrl = id ? `${baseUrl}/supplier/${id}/edit` : `${baseUrl}/supplier`
        ...
        $.ajax({
            ...
            processData: false,
            beforeSend: function() {
                saveBtn.html('<div class="spinner-border spinner-border-sm" supplier="status"></div>').prop('disabled', true)
